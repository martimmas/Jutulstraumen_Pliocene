...
UserVar.OutputExpName='jutul_slope_pli_hadcm3_shear_margins';
...
UserVar.AFile=[UserVar.IOFilesPath,'/InputAC/FA_bma_jutul_dhdte10_shear_margins.mat'];
...
%     CtrlVar.NameOfRestartFiletoRead=[UserVar.IOFilesPath,'/outputs/Restart-jutul_slope_pli_hadcm3_shear_margins-Forward-Transient-1500000'];
    CtrlVar.NameOfRestartFiletoRead=[UserVar.IOFilesPath,'/outputs/Restart-jutul_slope_pli_hadcm3_shear_margins-Forward-Transient-2000000'];
%     CtrlVar.NameOfRestartFiletoRead=[UserVar.IOFilesPath,'/outputs/Restart-jutul_slope_pli_hadcm3_shear_margins-Forward-Transient-2500000'];
