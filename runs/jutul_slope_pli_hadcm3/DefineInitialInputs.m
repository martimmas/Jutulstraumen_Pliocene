...
UserVar.OutputExpName='jutul_slope_pli_hadcm3_fc10_pax';
...
UserVar.WriteBackupRestartDt = 50;
%% Run-type specific
...
if CtrlVar.Restart==1    
    CtrlVar.NameOfRestartFiletoRead=[UserVar.IOFilesPath,'/outputs/Restart-jutul_slope_pli_hadcm3_fc10_pax-Forward-Transient-1500000'];
