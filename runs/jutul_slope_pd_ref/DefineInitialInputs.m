...
UserVar.OutputExpName='jutul_slope_pd_ref_fc10_bma_nc';
...
CtrlVar.DefineOutputsDt = 20;       % every years
UserVar.WriteBackupRestartDt = 200;
%% Run-type specific
...
UserVar.Qbm.Temp0 = 0.05; % Obtained from WOA18 (Locarnini et al., 2019)
