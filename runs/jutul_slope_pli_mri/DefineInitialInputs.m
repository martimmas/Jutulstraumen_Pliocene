...
UserVar.OutputExpName='jutul_slope_pli_mri_fc10_pax';
...
UserVar.SMB.Tclim_file=[UserVar.IOFilesPath,'/Interpolants/ant_wide/pliocene/FTc_MRI.mat'];
UserVar.SMB.Pclim_file=[UserVar.IOFilesPath,'/Interpolants/ant_wide/pliocene/FPc_MRI.mat'];
UserVar.SMB.s_ref_file=[UserVar.IOFilesPath,'/Interpolants/ant_wide/pliocene/Fsr_MRI.mat'];
...
UserVar.Qbm.Temp0 = 0.0; % avg. sub-ice shelf response in de Boer et al. (2015; TC) - PLISMIP-ANT

if CtrlVar.Restart==1
%     CtrlVar.NameOfRestartFiletoRead=[UserVar.IOFilesPath,'/outputs/Restart-jutul_slope_pli_mri_fc10_pax-Forward-Transient-1500000'];
    CtrlVar.NameOfRestartFiletoRead=[UserVar.IOFilesPath,'/outputs/Restart-jutul_slope_pli_mri_fc10_pax-Forward-Transient-2000000'];
