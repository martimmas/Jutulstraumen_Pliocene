function MeshBoundaryCoordinates=CreateMeshBoundaryCoordinatesForAntartica(UserVar,CtrlVar)
    
    load([UserVar.IOFilesPath,'/Interpolants/ant_wide/MeshBoundaryCoordinatesForAntarcticaBasedOnBedmachine'],'Boundary')
    xh0=Boundary(:,1); yh0=Boundary(:,2);
