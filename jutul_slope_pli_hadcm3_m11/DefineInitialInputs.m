...
UserVar.OutputExpName='jutul_slope_pli_hadcm3_m11';
...
% Domain
CtrlVar.ReadInitialMesh=1;           % defaultht_bdt 1
...
UserVar.CFile=[UserVar.IOFilesPath,'/InputAC/FC_bma210914_dhdte10_m11.mat']; 
UserVar.AFile=[UserVar.IOFilesPath,'/InputAC/FA_bma210914_dhdte10_m11.mat'];
...
%     CtrlVar.NameOfRestartFiletoRead=[UserVar.IOFilesPath,'/outputs/Restart-jutul_slope_pli_hadcm3_m11-Forward-Transient-1500000'];
%     CtrlVar.NameOfRestartFiletoRead=[UserVar.IOFilesPath,'/outputs/Restart-jutul_slope_pli_hadcm3_m11-Forward-Transient-2000000'];
%     CtrlVar.NameOfRestartFiletoRead=[UserVar.IOFilesPath,'/outputs/Restart-jutul_slope_pli_hadcm3_m11-Forward-Transient-2500000'];
    CtrlVar.NameOfRestartFiletoRead=[UserVar.IOFilesPath,'/outputs/Restart-jutul_slope_pli_hadcm3_m11-Forward-Transient-3000000'];
    CtrlVar.ReadInitialMesh=0;
    CtrlVar.AdaptMesh=1;
    CtrlVar.AdaptMeshInitial=0;
    CtrlVar.AdaptMeshTimeInterval=200;
end
