...
UserVar.OutputExpName='jutul_slope_pli_hadcm3_m1if';
...
UserVar.CFile=[UserVar.IOFilesPath,'/InputAC/FC10_bma210914_dhdte10_m1.mat']; 
UserVar.AFile=[UserVar.IOFilesPath,'/InputAC/FA_bma210914_dhdte10_m1.mat'];
...
if CtrlVar.Restart==1    
    CtrlVar.NameOfRestartFiletoRead=[UserVar.IOFilesPath,'/outputs/Restart-jutul_slope_pli_hadcm3_m1if-Forward-Transient-1500000'];
%     CtrlVar.NameOfRestartFiletoRead=[UserVar.IOFilesPath,'/outputs/Restart-jutul_slope_pli_hadcm3_m1if-Forward-Transient-2000000'];
%     CtrlVar.NameOfRestartFiletoRead=[UserVar.IOFilesPath,'/outputs/Restart-jutul_slope_pli_hadcm3_m1if-Forward-Transient-2500000'];
