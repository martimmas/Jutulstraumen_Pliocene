...
UserVar.OutputExpName='jutul_vest_pli_hadcm3_ht';
...
UserVar.SurfaceVelocityInterpolant=[UserVar.IOFilesPath,'/Interpolants/ant_wide/SurfVelMeasures990mInterpolants.mat'];

UserVar.CFile=[UserVar.IOFilesPath,'/InputAC/FC_jutul_vest.mat']; 
UserVar.AFile=[UserVar.IOFilesPath,'/InputAC/FA_jutul_vest.mat'];
...
UserVar.SMB.Tclim_file=[UserVar.IOFilesPath,'/Interpolants/ant_wide/pliocene/FTc_HadCM3.mat'];
UserVar.SMB.Pclim_file=[UserVar.IOFilesPath,'/Interpolants/ant_wide/pliocene/FPc_HadCM3.mat'];
UserVar.SMB.s_ref_file=[UserVar.IOFilesPath,'/Interpolants/ant_wide/pliocene/Fsr_HadCM3.mat'];
...
CtrlVar.AdaptMesh=1;                 
CtrlVar.AdaptMeshRunStepInterval=0; CtrlVar.AdaptMeshTimeInterval=50;
...
% This will take care of calving and ice shelf melting
...
UserVar.Qbm.Temp0 = 1.6; % avg. sub-ice shelf response in de Boer et al. (2015; TC) - PLISMIP-ANT

if CtrlVar.Restart==1    
%     CtrlVar.NameOfRestartFiletoRead=[UserVar.IOFilesPath,'/outputs/Restart-jutul_vest_pli_hadcm3_ht-Forward-Transient-1500000'];
%     CtrlVar.NameOfRestartFiletoRead=[UserVar.IOFilesPath,'/outputs/Restart-jutul_vest_pli_hadcm3_ht-Forward-Transient-2000000'];
%     CtrlVar.NameOfRestartFiletoRead=[UserVar.IOFilesPath,'/outputs/Restart-jutul_vest_pli_hadcm3_ht-Forward-Transient-2500000'];
%     CtrlVar.NameOfRestartFiletoRead=[UserVar.IOFilesPath,'/outputs/Restart-jutul_vest_pli_hadcm3_ht-Forward-Transient-3000000'];
